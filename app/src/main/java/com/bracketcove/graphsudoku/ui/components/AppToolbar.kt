...
/**
 * Reusable component - AppToolbar
 * @param modifier pass in a Modifier object to style the toolbar
 * @param title toolbar title
 * @param icon Composable icon component to display in the toolbar.
 * */
@Composable
fun AppToolbar(
    modifier: Modifier,
